...
function Intro() {
  return (
    <div className="intro">
      ...
      <p>
        The answers you give to the questions on this application must be true
        and correct. You may be subject to penalties if you make a false
        statement or withhold information.
      </p>
    </div>
  );
}
